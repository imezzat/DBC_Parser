...
public enum CAN1_Signals_S_039 implements CAN_Signal{
S_CHECKSUM_039("4","+","1","0","0","15","0"),
S_ALIVE_COUNTER_039("2","+","1","0","0","3","0"),
S_MID_FRONT("1","+","1","0","0","1","0"),
S_FAILURE("1","+","1","0","0","1","0"),
S_AIRBAG_DEPLOY("1","+","1","0","0","1","0"),
S_CDS_FRONT("1","+","1","0","0","1","0"),
;
private int Bits;
...
private static final String MsgName= MethodHandles.lookup().lookupClass().getSimpleName().substring(MethodHandles.lookup().lookupClass().getSimpleName().lastIndexOf("_Signals_")+1);
 CAN1_Signals_S_039(String Bits,String Signed_unsigned,String Factor,String offset,String MinDbc,String MaxDbc,String initialVal){
