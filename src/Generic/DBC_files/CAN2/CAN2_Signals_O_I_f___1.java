...
public enum CAN2_Signals_O_I_f___1 implements CAN_Signal{
O_Axdb_3_D_0("14","-","0.0002","0","-1","1","0"),
O_Axdb_R_0("16","+","0.0002","-1.571","-1.571","1.571","0"),
O_Axdb_L_0("16","+","0.0002","-1.571","-1.571","1.571","0"),
O_Mo_ca_0("4","+","1","0","0","15","0"),
O_A___V__0("12","-","0.05","0","-100","100","0"),
O_A___V__0("10","-","0.05","0","-25","25","0"),
O_A___V_S_0("12","+","0.00732601","0","0","30","0"),
O_A___V_S_0("10","+","0.0058651","0","0","6","0"),
;
private int Bits;
...
private static final String MsgName= MethodHandles.lookup().lookupClass().getSimpleName().substring(MethodHandles.lookup().lookupClass().getSimpleName().lastIndexOf("_Signals_")+1);
 CAN2_Signals_O_I_f___1(String Bits,String Signed_unsigned,String Factor,String offset,String MinDbc,String MaxDbc,String initialVal){
