...
public enum CAN2_Signals_RCanT implements CAN_Signal{
mux_Sig("8","+","1","0","0","255","0"),
CRC_SrrSync("8","+","1","0","0","255","0"),
Sig_1("4","+","1","0","0","15","0"),
Seq_Srr("4","+","1","0","0","15","0"),
UBy_Srr("8","+","1","0","0","255","0"),
S__T_Sec3___Lsb_SrrSync("32","+","1","0","0","4294967295","0"),
;
private int Bits;
...
private static final String MsgName= MethodHandles.lookup().lookupClass().getSimpleName().substring(MethodHandles.lookup().lookupClass().getSimpleName().lastIndexOf("_Signals_")+1);
 CAN2_Signals_RCanT(String Bits,String Signed_unsigned,String Factor,String offset,String MinDbc,String MaxDbc,String initialVal){
