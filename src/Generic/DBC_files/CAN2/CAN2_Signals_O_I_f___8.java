...
public enum CAN2_Signals_O_I_f___8 implements CAN_Signal{
O_I_f___8_MC("4","+","1","0","0","15","0"),
O_I_f___8_CRC("16","+","1","0","0","65535","0"),
O_O_____7("3","+","1","0","0","6","0"),
OIF_ID_7("7","+","1","0","0","63","0"),
O_R___V__7("13","-","0.05","0","-128","128","0"),
O_R___V__7("10","-","0.05","0","-25","25","0"),
O_W_t___7("7","+","0.05","0","0","6.35","0"),
O_P_____7("5","+","1","0","0","16","0"),
O_P___R_V_7("1","+","1","0","0","1","0"),
O_Axdb_3_D_7("14","-","0.0002","0","-1","1","0"),
O_Axdb_R_7("16","+","0.0002","-1.571","-1.571","1.571","0"),
O_Axdb_L_7("16","+","0.0002","-1.571","-1.571","1.571","0"),
O_Mo_ca_7("4","+","1","0","0","15","0"),
O_A___V__7("12","-","0.05","0","-100","100","0"),
O_A___V__7("10","-","0.05","0","-25","25","0"),
O_A___V_S_7("12","+","0.00732601","0","0","30","0"),
O_A___V_S_7("10","+","0.0058651","0","0","6","0"),
;
private int Bits;
...
private static final String MsgName= MethodHandles.lookup().lookupClass().getSimpleName().substring(MethodHandles.lookup().lookupClass().getSimpleName().lastIndexOf("_Signals_")+1);
 CAN2_Signals_O_I_f___8(String Bits,String Signed_unsigned,String Factor,String offset,String MinDbc,String MaxDbc,String initialVal){
