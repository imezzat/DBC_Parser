...
public enum CAN2_Signals_Msg_0 implements CAN_Signal{
FS_O_P_SIG_6("7","+","1","0","0","99","0"),
FS_OP_SIG_12("1","+","1","0","0","1","0"),
Res_7("7","+","1","0","0","99","0"),
Res_9("1","+","1","0","0","1","0"),
;
private int Bits;
...
private static final String MsgName= MethodHandles.lookup().lookupClass().getSimpleName().substring(MethodHandles.lookup().lookupClass().getSimpleName().lastIndexOf("_Signals_")+1);
 CAN2_Signals_Msg_0(String Bits,String Signed_unsigned,String Factor,String offset,String MinDbc,String MaxDbc,String initialVal){
