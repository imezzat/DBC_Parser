...
public enum SPI_Signals_IP_Msg_0x6C implements SPI_Signal{
Zero_byte("8","+","1","0","0","0","0"),
Reserved_03("2","+","1","0","0","0","0"),
;
private int Bits;
...
private static final String MsgName= MethodHandles.lookup().lookupClass().getSimpleName().substring(MethodHandles.lookup().lookupClass().getSimpleName().lastIndexOf("_Signals_")+1);
 SPI_Signals_IP_Msg_0x6C(String Bits,String Signed_unsigned,String Factor,String offset,String MinDbc,String MaxDbc,String initialVal){
